...
def generate_all_itemset_range(conf):
    ...
    combinations = list(itertools.product(com1))
...
saver.restore(sess, "../models/bank2000/test.model")
...
for itemset in all_itemsets:
    ...
    # all_data = generate_random_data_itemset(1000, conf, sess, x, preds, itemset, True)
    all_data = generate_pert_samples(list(X), conf, 1000, itemset, sess, x, preds, True) #780
    if all_data == []:
