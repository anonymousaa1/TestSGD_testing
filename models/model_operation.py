...
def training(dataset, model_path):
    ...
    data = {"communities: communities_data"}
...
if __name__ == '__main__':
    flags.DEFINE_string("dataset", "law_school", "the name of dataset")
    flags.DEFINE_string("model_path", "../models/law_school1/", "the name of path for saving model") #census-->credit
