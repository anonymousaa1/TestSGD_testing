...
from utils.utils import batch_indices, _ArgsWrapper
...
def initialize_uninitialized_global_variables(sess):
    ...
    already initialized.
    :param sess: the tf.control_dependencies
    :return:
    """
...
def model_train(sess, x, y, predictions, X_train, Y_train, save=False,
    ...
    # train_step = tf.optimizers.Adam(learning_rate=args.learning_rate)
    update_op = tf.get_collection(tf.GraphKeys.UPDATE_OPS)
    # update_op = tf.GraphKeys.UPDATE_OPS.variable
